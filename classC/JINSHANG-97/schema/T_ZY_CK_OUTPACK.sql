...
fields(
 ...
 "firstindatetime"      type datetime format '%Y/%m/%d %H:%M:%S',
 "inbillid"  type str,
 ...
 "outbilldatetime"      type datetime format '%Y/%m/%d %H:%M:%S',
 "rollply"  type double,
 "readyout"  type datetime format '%Y/%m/%d %H:%M:%S',
 "validdatetime"      type datetime format '%Y/%m/%d %H:%M:%S',
