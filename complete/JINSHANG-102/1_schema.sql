...
create index T_ZY_RK_INBILLDETAIL_index on table T_ZY_RK_INBILLDETAIL PRIMARY KEY(GOODSID);

create schema T_ZY_JG_PROCARTICLEDTL_schema
source type CSV
fields(
  "PROCARTICLEDTLID"     type string,
  "DEPTID"               type string,
...
create index T_ZY_JG_PROCARTICLEDTL_index on table T_ZY_JG_PROCARTICLEDTL PRIMARY KEY(PROCARTICLEDTLID);
...
create index T_ZY_GH_CHANGEOWNERLIST_index on table T_ZY_GH_CHANGEOWNERLIST PRIMARY KEY(CHANGEOWNERID);
...
create index T_ZY_GH_CHANGEOWNERDETAIL_index on table T_ZY_GH_CHANGEOWNERDETAIL PRIMARY KEY(MANAGENO);
...
create index T_ZY_CK_OUTPACK_index on table T_ZY_CK_OUTPACK PRIMARY KEY(OUTPACKID);
...
create index T_ZY_CK_CLEAR_index on table T_ZY_CK_CLEAR PRIMARY KEY(GOODSID);
...
fields(
 ...
 "vf_PROCESSID" type `expr` data type string value  iilmap("PROCESSID_map",PROCESSID,DEPTID)
)
RECORD DELIMITER "LF"
FIELD DELIMITER ","
TEXT QUALIFIER "DQM";
...
create index T_ZY_JG_PROCMATERIALDTL_index on table T_ZY_JG_PROCMATERIALDTL PRIMARY KEY(PROCMATERIALDTLID);
...
create index T_ZY_JG_PROCESS_index on table T_ZY_JG_PROCESS PRIMARY KEY(PROCESSID);

create map PROCESSID_map on table T_ZY_JG_PROCESS
KEY (PROCESSID,DEPTID)
VALUE ('1')
TYPE string
...
create index T_ZY_GH_CHANGEOWNERLIST_T_ZY_GH_CHANGEOWNERDETAIL_index on table T_ZY_GH_CHANGEOWNERLIST_T_ZY_GH_CHANGEOWNERDETAIL PRIMARY KEY(CHANGEOWNERID);
...
create index union_all_index on table union_all PRIMARY KEY(OWNERID,MANAGENO,GOODSOWNERMANAGENO,PACKNUM);

create statistics model union_all_model on table union_all
group by (OWNERID,OWNERNAME,MANAGENO,GOODSOWNERMANAGENO,PACKNUM,GRADENUM,GOODSLOCID,KINDNAME,SHOPSIGNNAME,PRODAREANAME,FIRSTINDATE)
